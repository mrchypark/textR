...
.pull-right[
  <img src=https://cdn.namuwikiusercontent.com/s/47f895cbea4e349bc92bb773809d35f63f6ffa3de4c9e7c9bbfbdb8d7ab07cdd874510f6d749e9b96c4b5123478a9a77a1360c2d26b94dd85fbff6fe7f35f87d2153242b74e6512d9283fac5bdfe0cae?e=1544521711&k=ApwZvLBifj767cef4_rIhA width=60%>
]
...
```{}
> library(RcppMeCab)
> pos("롯데마트가판매하고있는흑마늘양념치킨이논란이되고있다.")
```
```
...
```{r}
library(KoNLP)
SimplePos09("롯데마트가판매하고있는흑마늘양념치킨이논란이되고있다.")
```
]

---

## [KoSpacing](https://github.com/haven-jeon/KoSpacing) 패키지
